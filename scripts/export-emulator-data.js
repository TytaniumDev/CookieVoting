...
async function exportData() {
  ...
  try {
    ...
    writeFileSync(join(authDir, 'accounts.json'), JSON.stringify(authExport, null, 2));
    ...
    writeFileSync(join(firestoreDir, 'data.json'), JSON.stringify(firestoreExport, null, 2));
