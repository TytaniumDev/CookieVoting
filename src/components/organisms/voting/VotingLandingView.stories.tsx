...
const mockCategories: Category[] = [
    { id: '1', name: 'Best Taste', imageUrl: 'https://placehold.co/300x300/orange/white?text=Taste', cookies: [] },
    { id: '2', name: 'Best Look', imageUrl: 'https://placehold.co/300x300/purple/white?text=Look', cookies: [] },
    { id: '3', name: 'Most Creative', imageUrl: 'https://placehold.co/300x300/green/white?text=Creative', cookies: [] },
];
