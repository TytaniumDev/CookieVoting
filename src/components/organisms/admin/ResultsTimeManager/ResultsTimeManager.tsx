...
import styles from './ResultsTimeManager.module.css';
...
export function ResultsTimeManager({ eventId }: ResultsTimeManagerProps) {
    ...
    return (
        <div className={styles.container}>
            <label htmlFor="results-time-picker" className={styles.label}>
            ...
            <p className={styles.helperText}>Votes will be hidden until this time</p>
        </div>
    );
}
