...
function CategoryCardWithProcessing({
  ...
  const { status: processingStatus, errorMessage: processingError } = useCategoryProcessing(
    category.batchId || null,
  );
  return (
    <CategoryCard
      id={category.id}
...
export function CategoryManager({ eventId, onCategoryClick }: CategoryManagerProps) {
  ...
  const onSubmit = useCallback(
    async (data: CategoryCreateFormData) => {
      ...
      fetch('http://127.0.0.1:7242/ingest/46f7a595-7888-424b-9f1c-56c8a6eb8084', {
        ...
        body: JSON.stringify({
          location: 'CategoryManager.tsx:120',
          message: 'onSubmit entry',
          data: { eventId, processWithVisionAPI, fileName: data.image?.name },
          timestamp: Date.now(),
      ...
      try {
        ...
        fetch('http://127.0.0.1:7242/ingest/46f7a595-7888-424b-9f1c-56c8a6eb8084', {
          ...
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            location: 'CategoryManager.tsx:125',
            message: 'before uploadImage',
            data: { sanitizedName, fileSize: data.image?.size },
            timestamp: Date.now(),
            sessionId: 'debug-session',
            runId: 'run1',
            hypothesisId: 'A',
        ...
        fetch('http://127.0.0.1:7242/ingest/46f7a595-7888-424b-9f1c-56c8a6eb8084', {
          ...
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            location: 'CategoryManager.tsx:130',
            message: 'after uploadImage',
            data: { imageId: imageEntity?.id, imageUrl: imageEntity?.url },
            timestamp: Date.now(),
            sessionId: 'debug-session',
            runId: 'run1',
            hypothesisId: 'A',
        ...
        if (processWithVisionAPI) {
          ...
          fetch('http://127.0.0.1:7242/ingest/46f7a595-7888-424b-9f1c-56c8a6eb8084', {
            ...
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
              location: 'CategoryManager.tsx:136',
              message: 'before addCategoryFirestore',
              data: { batchId, eventId, sanitizedName },
              timestamp: Date.now(),
              sessionId: 'debug-session',
              runId: 'run1',
              hypothesisId: 'B',
          ...
          const category = await addCategoryFirestore(
            eventId,
            sanitizedName,
            imageEntity.url,
            batchId,
          ...
          fetch('http://127.0.0.1:7242/ingest/46f7a595-7888-424b-9f1c-56c8a6eb8084', {
            ...
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
              location: 'CategoryManager.tsx:141',
              message: 'after addCategoryFirestore',
              data: { categoryId: category?.id, batchId },
              timestamp: Date.now(),
              sessionId: 'debug-session',
              runId: 'run1',
              hypothesisId: 'B',
          ...
          fetch('http://127.0.0.1:7242/ingest/46f7a595-7888-424b-9f1c-56c8a6eb8084', {
            ...
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
              location: 'CategoryManager.tsx:144',
              message: 'before uploadTray',
              data: { batchId, eventId, categoryId: category?.id, fileSize: data.image?.size },
              timestamp: Date.now(),
              sessionId: 'debug-session',
              runId: 'run1',
              hypothesisId: 'C',
          ...
          fetch('http://127.0.0.1:7242/ingest/46f7a595-7888-424b-9f1c-56c8a6eb8084', {
            ...
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
              location: 'CategoryManager.tsx:147',
              message: 'after uploadTray',
              data: { batchId },
              timestamp: Date.now(),
              sessionId: 'debug-session',
              runId: 'run1',
          ...
          fetch('http://127.0.0.1:7242/ingest/46f7a595-7888-424b-9f1c-56c8a6eb8084', {
            ...
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
              location: 'CategoryManager.tsx:153',
              message: 'before addCategory (non-Vision)',
              data: { eventId, sanitizedName },
              timestamp: Date.now(),
              sessionId: 'debug-session',
              runId: 'run1',
              hypothesisId: 'D',
          ...
          fetch('http://127.0.0.1:7242/ingest/46f7a595-7888-424b-9f1c-56c8a6eb8084', {
            ...
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
              location: 'CategoryManager.tsx:156',
              message: 'after addCategory (non-Vision)',
              data: { eventId },
              timestamp: Date.now(),
              sessionId: 'debug-session',
              runId: 'run1',
        ...
        fetch('http://127.0.0.1:7242/ingest/46f7a595-7888-424b-9f1c-56c8a6eb8084', {
          ...
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            location: 'CategoryManager.tsx:162',
            message: 'onSubmit success',
            data: {},
            timestamp: Date.now(),
            sessionId: 'debug-session',
            runId: 'run1',
        ...
        fetch('http://127.0.0.1:7242/ingest/46f7a595-7888-424b-9f1c-56c8a6eb8084', {
          ...
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            location: 'CategoryManager.tsx:171',
            message: 'onSubmit error',
            data: {
  ...
  return (
    <div className="space-y-6">
      ...
      {error && (
        <div
          className="text-red-400 text-sm p-3 bg-red-900/20 border border-red-900/50 rounded-lg"
          role="alert"
        >
          {error}
        </div>
