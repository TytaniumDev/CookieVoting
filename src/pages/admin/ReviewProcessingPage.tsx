              ...
              >
                <span
                  className={`absolute -top-6 left-0 text-xs font-bold px-1.5 py-0.5 rounded shadow-sm select-none ${
                    selectedCropIndex === i ? 'bg-yellow-400 text-black' : 'bg-green-500 text-white'
                  }`}
                >
                  #{i + 1}
                </span>
      ...
      {selectedCropIndex !== null ? (
        <div className="bg-gray-800 border-t border-gray-700 p-4 flex flex-wrap justify-center gap-6 sticky bottom-0 z-50 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.3)] text-gray-100">
          <div className="flex flex-col items-center justify-center">
            <span className="text-xs font-bold text-gray-400 mb-1 uppercase tracking-wider">
              Actions
            </span>
        ...
        <div className="bg-gray-800 border-t border-gray-700 p-4 flex justify-center items-center gap-4 sticky bottom-0 z-50 text-gray-300">
          ...
          <span className="text-sm">
            Tap on the image to add a new cookie box. Drag boxes to move/resize.
          </span>
        </div>
      )}
    </div>
